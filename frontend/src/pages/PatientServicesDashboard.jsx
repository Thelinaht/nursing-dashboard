...
export default function PatientServicesDashboard() {
    ...
    const fetchKPIs = async () => {
        try {
            const [nursesRes, reqRes, unitsRes] = await Promise.all([
            ...
            // Build unit stats: for each unit in Hospital_unit, count nurses
            setKpis({
            ...
            <div className="psd-container">
                ...
                <div className="psd-summary-grid">
                    ...
                    <div className="glass-card green">
                        <p><Building2 size={20} /> Total Units</p>
                        <h1>{kpis.totalUnits ?? "—"}</h1>
                    </div>
                    <div className="glass-card yellow">
                        <p><ClipboardList size={20} />Pending Requests</p>
